...
"""返回整洁的描述性信息。"""
long_name = f"{self.year} {self.manufacturer} {self.model}" return long_name.title()
...
def __init__(self, battery_size=75): """初始化电瓶的属性。""" self.battery_size = battery_size
...
练习答案
  def get_range(self): """打印一条消息，指出电瓶的续航里程。""" if self.battery_size == 75:
           range = 260
...
range = 315
       ...
       print(message)
def upgrade_battery(self): """在可能的情况下将电瓶升级。""" if self.battery_size == 75:
